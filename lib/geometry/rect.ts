/**
 * origin: https://github.com/noya-app/noya/blob/main/packages/noya-geometry/src/rect.ts
 */
import { AffineTransform } from "./affine-transform";
import { isNumberEqual } from "../misc";
...
export function isRotatedRectContainsPoint(points: Point[], p: Point): boolean {
...
export function isRectContainsPoint(rect: Rect, point: Point): boolean {
  return (
    rect.x <= point.x &&
...
export function isRectsIntersect(a: Rect, b: Rect): boolean {
